...
class Ant(Insect):
    ...
    def __init__(self, armor=1):
        ...
        self.buff = False #buff from queen
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        tmp = self.place
        count = 0
        while tmp is not None and tmp is not beehive :
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        ...
        if bee is not None:
            ...
            return True # eat a bee 
        else:
            return False # fali to eat
        # END Problem 6
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if self.identity == 'queen':
            ScubaThrower.action(self,gamestate)
            tmp = self.place.exit
            while tmp is not None:
                if tmp.ant is not None and tmp.ant.buff == False:
                    tmp.ant.buff = True
                    tmp.ant.damage *= 2
                tmp = tmp.exit
            
        elif self.identity == 'imposter':
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0 and self.identity == 'queen':
            bees_win()
        # END Problem EC
    
    def remove_from(self, place):
        if self.identity == 'imposter':
